...
async function startBot() {
  ...
  try {
      ...
      async update => {
        ...
        if (
          ...
          if (
            ...
            console.log(
              "WhatsApp session logged out. Delete auth_info_baileys before pairing again."
            );
            return;
          }
    ...
    /*
     * Pairing code:
     * Existing session থাকলে pairing request করবে না।
     */
    if (
...
// PART 5/5 — WEB PANEL + PAIRING + SERVER START
// ============================================================
